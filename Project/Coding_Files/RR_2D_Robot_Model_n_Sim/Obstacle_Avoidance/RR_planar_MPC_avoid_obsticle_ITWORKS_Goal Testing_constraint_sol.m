...
Q = zeros(4,4); Q(1,1)=1; Q(2,2) = 1;Q(3,3) =1 ;Q(4,4) =1 ; % Weighting matrices (states)
...
args.ubg(4*(N+1) + 5:2:4*(N+1) + 4 + N) = -.1; %-.01; 
...
figure(3)
video_path = 'C:\Users\Indy-Windows\Documents\ECH-267-Adv.-Proc.-Control\Project\Report\images\OBS_Avoid_TEST_constraint_sol';
