...
\begin{figure}[ht]%
    \centering
    \subfloat[\centering label 1]{{\includegraphics[width=.43\linewidth]{no_obj_path_1} }}%
    \qquad
    \subfloat[\centering label 2]{{\includegraphics[width=.43\linewidth]{no_obj_path_2} }}%
    % \caption{2 Figures side by side}%
    \\
    \subfloat[\centering label 3]{{\includegraphics[width=.43\linewidth]{no_obj_path_3} }}%
    \qquad
...
Control Action and blah blah blah

\begin{figure}[ht]%
    \centering
    \subfloat[\centering label 1]{{\includegraphics[width=.43\linewidth]{Nominal_MPC/T1_X_init_25_45_0_0_X_ref_180_n45_0_0/pos} }}%
    \qquad
    \subfloat[\centering label 2]{{\includegraphics[width=.43\linewidth]{Nominal_MPC/T1_X_init_25_45_0_0_X_ref_180_n45_0_0/vel} }}%
    % \caption{2 Figures side by side}%
    \\
    \subfloat[\centering label 3]{{\includegraphics[width=.43\linewidth]{Nominal_MPC/T1_X_init_25_45_0_0_X_ref_180_n45_0_0/tor} }}%
    % \qquad
    % \subfloat[\centering label 4]{{\includegraphics[width=.43\linewidth]{no_obj_path_final} }}%
...
Enter Model parameter mismatch here.
